...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    fetchUserCount();
    const intervalUser = setInterval(fetchUserCount, 30000);
  ...
  useEffect(() => {
    ...
    const intervalRestaurant = setInterval(fetchRestaurantCount, 30000);
  ...
  useEffect(() => {
    ...
    const intervalOrders = setInterval(fetchOrderCountsAndEarnings, 30000);
